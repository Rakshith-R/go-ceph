...
// validate validates the FileBlockDiffInfo struct.
func (info *FileBlockDiffInfo) validate() error {
	if info.cephFileBlockDiffInfo == nil {
		return errors.New("invalid FileBlockDiffInfo: nil value")
	}
...
// It returns a FileBlockDiffChangedBlocks struct that contains
